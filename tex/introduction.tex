...
\end{tikzpicture}
\caption{The main contributions from this thesis in the time-accuracy graph (Figure~\ref{fig:main_diagram}). The roman number on each contribution links to the original published text. A discussion on each individual contribution is available in Chapter~\ref{sec:contributions}.} 
