...
\begin{figure}
\centering
\includegraphics[draft, width=0.9\textwidth]{figures/photorealistic_diagram.png}  \\
\caption{Comparing diffferent preview techniques. From left to right: converged image, noisy unconverged image, downsampled image, different physical model, diffuse appearance. All images took 5 seconds to render on a GPU ray tracer. Converged result took 4 hours.} 
