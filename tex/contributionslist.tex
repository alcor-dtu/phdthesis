...
\item  \textbf{Contribution \ref{sec:pointcloudnote}}: \textbf{Jeppe Revall Frisvad, Alessandro Dal Corso}. \textit{Point cloud method for rendering BSSRDFs.} Unpublished note. %Text in Appendix~\ref{sec:pointcloudnote}.
