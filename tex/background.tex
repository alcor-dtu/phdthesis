...
\end{equation*} 
Through the diffusion approximation, we can approximate the diffusive exitant radiance $M_d$ as
\begin{equation*}
...
\end{tabular}
\caption{Different representations for BRDFs. To the right, standard representation using polar coordinates. To the right, the representation from~\cite{Rusinkiewicz1998}. } 
\label{fig:brdfrepr}
\end{figure}
